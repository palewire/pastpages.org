...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Screenshot', fields ['timestamp']
        db.create_index(u'archive_screenshot', ['timestamp'])

    def backwards(self, orm):
        # Removing index on 'Screenshot', fields ['timestamp']
        db.delete_index(u'archive_screenshot', ['timestamp'])
    ...
    models = {
        ...
        u'archive.screenshot': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
