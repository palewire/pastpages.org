...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.display_url'
        db.add_column('archive_site', 'display_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Site.display_url'
        db.delete_column('archive_site', 'display_url')
    ...
    models = {
        ...
        'archive.site': {
            ...
            'display_url': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
