...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.on_the_homepage'
        db.add_column('archive_site', 'on_the_homepage',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Site.on_the_homepage'
        db.delete_column('archive_site', 'on_the_homepage')
