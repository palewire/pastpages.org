...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.sortable_name'
        db.add_column('archive_site', 'sortable_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Site.sortable_name'
        db.delete_column('archive_site', 'sortable_name')
    ...
    models = {
        ...
        'archive.site': {
            ...
            'sortable_name': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
