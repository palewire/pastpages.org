...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('transport', ['Queue'])
        ...
        db.create_table('djkombu_message', (
            ...
            ('queue', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['transport.Queue'])),
        ))
        db.send_create_signal('transport', ['Message'])
    ...
    models = {
        'transport.message': {
            ...
            'queue': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['transport.Queue']"}),
