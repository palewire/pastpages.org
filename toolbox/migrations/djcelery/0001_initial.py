...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('celery_taskmeta', (
            ...
            ('meta', self.gf('djcelery.picklefield.PickledObjectField')(default=None, null=True)),
        ))
        ...
        db.create_table('djcelery_crontabschedule', (
            ...
            ('day_of_month', self.gf('django.db.models.fields.CharField')(default='*', max_length=64)),
            ('month_of_year', self.gf('django.db.models.fields.CharField')(default='*', max_length=64)),
        ))
